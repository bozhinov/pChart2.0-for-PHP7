...
$myPicture->myData->setScatterSerieProperties(1, ["Description" => "Last Year", "Picture" => "examples/resources/accept.png"]);
...
$myPicture->drawText(10,15,"drawScatterPlotChart() - Draw a scatter plot chart",["Color"=>new pColor(255)]);
