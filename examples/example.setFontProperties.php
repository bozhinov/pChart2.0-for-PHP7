...
/* Write some text */ 
$myPicture->setFontProperties(array("FontName"=>"pChart/fonts/GeosansLight.ttf","FontSize"=>20));
...
/* Write some text */ 
$myPicture->setFontProperties(array("FontName"=>"pChart/fonts/MankSans.ttf","FontSize"=>30,"R"=>231,"G"=>50,"B"=>36));
$myPicture->drawText(340,90,"Some big red text");

/* Write some text */ 
$myPicture->setFontProperties(array("FontName"=>"pChart/fonts/Silkscreen.ttf","FontSize"=>6,"R"=>29,"G"=>70,"B"=>111));
