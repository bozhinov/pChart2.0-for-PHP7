...
$myPicture->drawCircle(480,60,20,20, ["Color"=>new pColor(209,31,27)]);
$myPicture->drawCircle(480,100,30,20,["Color"=>new pColor(209,125,27)]);
$myPicture->drawCircle(480,140,40,20,["Color"=>new pColor(209,198,27),"Ticks"=>4]);
$myPicture->drawCircle(480,180,50,20,["Color"=>new pColor(134,209,27),"Ticks"=>4]);
