...
$myPicture->drawGradientArea(0,0,600,20,DIRECTION_VERTICAL,["StartR"=>0,"StartG"=>0,"StartB"=>0,"EndR"=>100,"EndG"=>100,"EndB"=>100,"Alpha"=>80]);

/* Add a border to the picture */
$myPicture->drawRectangle(0,0,599,599,["R"=>0,"G"=>0,"B"=>0]);
