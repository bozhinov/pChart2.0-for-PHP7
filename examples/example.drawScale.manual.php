...
/* Draw the scale */
$AxisBoundaries = array(0=>["Min"=>0,"Max"=>100]);
$myPicture->drawScale(["Mode"=>SCALE_MODE_MANUAL,"ManualScale"=>$AxisBoundaries,"DrawSubTicks"=>TRUE,"DrawArrows"=>TRUE,"ArrowSize"=>6]);
