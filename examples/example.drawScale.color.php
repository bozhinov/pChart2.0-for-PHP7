...
$myPicture->myData->setAxisColor(0,new pColor(102,129,63));
$myPicture->myData->setAxisColor(1,new pColor(129,72,63));
$myPicture->myData->setAxisColor(2,new pColor(63,89,129));
