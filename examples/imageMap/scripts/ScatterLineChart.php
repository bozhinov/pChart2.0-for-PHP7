...
$myPicture = new pImageMapFile(400,400,FALSE,"ImageMapScatterChart",IMAGE_MAP_STORAGE_FILE,"ScatterChart","temp");
...
$myScatter->drawScatterLineChart(["RecordImageMap"=>TRUE]);
...
$myPicture->autoOutput("temp/ScatterLineChart.png");
