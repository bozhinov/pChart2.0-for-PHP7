...
$myPicture->drawText(10,13,"drawStackedBarChart() - draw a stacked bar chart",["R"=>255,"G"=>255,"B"=>255]);
...
$pCharts->drawStackedBarChart(["DisplayValues"=>TRUE,"DisplayColor"=>DISPLAY_AUTO,"Rounded"=>TRUE,"Surrounding"=>60]);
...
$myPicture->autoOutput("temp/example.drawStackedBarChart.png");
