...
$myPicture->drawGradientArea(0,0,300,20, DIRECTION_VERTICAL, ["StartColor"=>ColorBlack(),"EndColor"=>new pColor(50,50,50,80)]);
...
$myPicture->setShadow(TRUE,["X"=>2,"Y"=>2,ColorBlack($Alpha=50)]);

/* Create the pPie object */ 
$PieChart = new pPie($myPicture);

/* Draw an AA pie chart */ 
$PieChart->draw2DPie(160,140,["DrawLabels"=>TRUE,"LabelStacked"=>TRUE,"Border"=>TRUE]);
...
$myPicture->autoOutput("temp/example.draw2DPie.labels.png");
