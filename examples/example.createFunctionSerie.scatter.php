...
$myPicture->myData->createFunctionSerie("X","1/z",array("MinX"=>-10,"MaxX"=>10,"XStep"=>1));
...
/* Create the Y axis */
$myPicture->myData->createFunctionSerie("Y","z",array("MinX"=>-10,"MaxX"=>10,"XStep"=>1));
...
/* Create the Y axis */
$myPicture->myData->createFunctionSerie("Y2","z*z*z",array("MinX"=>-10,"MaxX"=>10,"XStep"=>1));
...
$myPicture->myData->setScatterSerieColor(1,array("R"=>120,"G"=>0,"B"=>255));
