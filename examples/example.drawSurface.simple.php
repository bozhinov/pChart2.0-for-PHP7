...
$myPicture->drawGradientArea(0,0,210,20, DIRECTION_VERTICAL,["StartColor"=>new pColor(0), "EndColor"=>new pColor(50)]);
...
$myPicture->drawText(10,13,"pSurface() :: Surface charts",["Color"=>new pColor(255)]);
