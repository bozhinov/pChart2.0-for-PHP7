...
$myPicture->drawText(10,13,"drawStepChart() - draw a step chart",["Color"=>new pColor(255,255,255)]);
...
$myPicture->setShadow(TRUE,["X"=>1,"Y"=>1,"Color"=>new pColor(255,255,255,10)]);
$myPicture->setFontProperties(["FontName"=>"pChart/fonts/pf_arma_five.ttf","FontSize"=>6]);
$pCharts->drawStepChart(["DisplayValues"=>TRUE,"DisplayType"=>DISPLAY_AUTO]);
...
$myPicture->autoOutput("temp/example.drawStepChart.png");
