...
$myPicture->drawText(10,13,"pRadar - Draw polar charts",["R"=>255,"G"=>255,"B"=>255]);
...
$Options = ["BackgroundGradient"=>["StartR"=>255,"StartG"=>255,"StartB"=>255,"StartAlpha"=>100,"EndR"=>207,"EndG"=>227,"EndB"=>125,"EndAlpha"=>50], "FontName"=>"pChart/fonts/pf_arma_five.ttf", "FontSize"=>6];
$SplitChart->drawPolar($Options);

/* Draw a polar chart */ 
$SplitChart->myPicture->setGraphArea(350,25,690,225);
$Options = ["LabelPos"=>RADAR_LABELS_HORIZONTAL,"BackgroundGradient"=>["StartR"=>255,"StartG"=>255,"StartB"=>255,"StartAlpha"=>50,"EndR"=>32,"EndG"=>109,"EndB"=>174,"EndAlpha"=>30], "AxisRotation"=>0, "DrawPoly"=>TRUE, "PolyAlpha"=>50, "FontName"=>"pChart/fonts/pf_arma_five.ttf", "FontSize"=>6];
$SplitChart->drawPolar($Options);
