...
<script>
	...
	function render(PictureName)
	{
		...
		ajaxRender(PictureName, PictureName);
	}

	function ajaxRender(URL, SourceURL) // render the picture
	{
		$.ajax({
			url: URL,
			method: "POST",
...
<table><tr><td><img src='resources/application_view_list.png' width=16 height=16 alt=''/></td><td>&nbsp;Source area</td></tr></table>
