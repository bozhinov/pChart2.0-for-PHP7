...
while (($FileName = readdir($DirectoryHandle)) !== false)
{
	if (!in_array($FileName,$Exclusion)){
		...
		$Tree[$Categorie][] = ["FileName"=>$FileName,"FileShortName"=>$FileShortName];
	}
}
...
foreach($Tree as $Key => $Elements){
	...
	if ($ID == count($Tree)) {
		$Icon = "dash-explorer-last.png"; $SubIcon = "dash-explorer-blank.png"; 
	} else { 
		$Icon = "dash-explorer.png"; $SubIcon = "dash-explorer-noleaf.png"; 
	}
...
?>
 <div style='width: 300px; background-color: #FB8B8E; border: 1px solid #CB5B5E; margin: 10px; font-family: tahoma;'>
  ...
  <div style='padding: 4px; font-family: tahoma; font-size: 11px;' align='justify'>
   ...
   <br><br>
   &nbsp;&nbsp;-&nbsp;PHP must be at least <b>7.x</b><br/>
