...
$myPicture->setShadow(TRUE,["X"=>2,"Y"=>2,"R"=>0,"G"=>0,"B"=>0,"Alpha"=>30]);  
$Settings = ["R"=>255,"G"=>255,"B"=>255,"BorderR"=>0,"BorderG"=>0,"BorderB"=>0];
$myPicture->drawRoundedFilledRectangle(10,10,590,300,10,$Settings);

/* Draw the cell divisions */
$myPicture->setShadow(FALSE);  
$Settings = ["R"=>0,"G"=>0,"B"=>0];
...
$Settings = ["R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPLEFT];
...
$myPicture->setFontProperties(["FontName"=>"pChart/fonts/Forgotte.ttf","FontSize"=>16]); 
$myPicture->drawText(70,20,"BEBEER INC\r\n342, MAIN STREET\r\n33000 BORDEAUX\r\nFRANCE",$Settings); 
$myPicture->drawText(250,20,"MUSTAFA'S BAR\r\n18, CAPITOL STREET\r\n31000 TOULOUSE\r\nFRANCE",$Settings); 

$myPicture->setFontProperties(["FontName"=>"pChart/fonts/Forgotte.ttf","FontSize"=>35]); 
$myPicture->drawText(100,120,"2342355552340",$Settings); 

$myPicture->setFontProperties(["FontName"=>"pChart/fonts/Forgotte.ttf","FontSize"=>20]); 
$Settings = ["R"=>0,"G"=>0,"B"=>0,"Align"=>TEXT_ALIGN_TOPRIGHT];
...
$Settings = ["ShowLegend"=>TRUE,"Height"=>55,"DrawArea"=>TRUE,"DrawArea"=>FALSE]; 
$Barcode39->draw("12250000234502",30,220,$Settings); 

$Settings = ["ShowLegend"=>TRUE,"Height"=>14,"DrawArea"=>TRUE,"DrawArea"=>FALSE]; 
...
$Settings = ["ShowLegend"=>TRUE,"Height"=>65,"DrawArea"=>TRUE,"DrawArea"=>FALSE]; 
$Barcode128->draw("TLSE",450,25,$Settings); 
