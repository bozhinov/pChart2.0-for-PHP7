...
$myBubbleChart->drawBubbleChart($bubbleDataSeries,$bubbleWeightSeries,["BorderWidth"=>4,"BorderColor"=>new pColor(0,0,0,50),"Surrounding"=>20]);

/* Write the chart legend */
$myPicture->drawLegend(570,13,["Style"=>LEGEND_NOBORDER,"Mode"=>LEGEND_HORIZONTAL]);

/* Render the picture (choose the best way) */
$myPicture->autoOutput("temp/example.drawBubbleChart.simple.png");
